...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('tile_based_game0.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('tile_based_game0.wasm', import.meta.url).href;
}
...
var _normalQuit = Module['_normalQuit'] = createExportWrapper('normalQuit', 0);
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 4565524;
